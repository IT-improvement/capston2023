    ...
    function moveQuestionPage(){
    	...
    	var form = document.moveform;
    		...
    		case 0:
    			...
    			break;
    		case 1:
    		form.action = "${path}/problomSovingPage1?"+Language[0];
    		break;
    		case 2:
    		form.action = "${path}/problomSovingPage1?"+Language[0]+Language[1];
    		break;
    		case 3:
    		form.action = "${path}/problomSovingPage1?"+Language[0]+Language[1]+Language[2];
    		break;
    		case 4:
    		form.action = "${path}/problomSovingPage1?"+Language[0]+Language[1]+Language[3];
    		break;
