      ...
      <div class="main-content container">
       <div class="col-sm-12">
			<div class="card card-default card-table">
				<div class="card-header">게시판 <a href="${path}/addPostForm" class="btn btn-primary float-right">게시글 추가</a></div>
				<div class="card-body">
					<table class="table table-striped table-hover" id="table1">
						...
						<tbody>
							<c:forEach var="mvcboard" items="${noticeBoardDTO}">
								<tr>
									<td class="center">${mvcboard.idx}</td>
									<td class="center"><a
										href="${path}/boardContents?idx=${mvcboard.idx}">${mvcboard.title}</a></td>
									<td class="center">${mvcboard.name}</td>
									<td class="center">${mvcboard.postdate}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
