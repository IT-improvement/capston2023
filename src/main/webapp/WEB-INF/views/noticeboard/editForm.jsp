        ...
        <div class="col-sm-12">
            <div class="card card-default card-table">
                ...
                <div class="card-body">
                    ...
                    <!-- 게시글 수정 폼 -->
                    <form action="${path}/editPost" method="post" modelAttribute="editedPost"> <!--  modelAttribute="editedPost"는 form에서 입력한 데이터값을 바인딩해 객체로 만들어 컨트롤러로 넘긴다.. -->
                        <input type="hidden" name="idx" value="${mvcboard.idx}" />
                        <div class="form-group">
                            <label for="title">제목</label>
                            <input type="text" id="title" name="title" class="form-control" value="${mvcboard.title}" required />
                        </div>
                        <div class="form-group">
                            <label for="content">내용</label>
                            <textarea id="content" name="content" class="form-control" required>${mvcboard.content}</textarea>
                        </div>
